<div>
    <form wire:submit="save">
        ...
        <div x-data="mdToolbar()" class="border border-gray-300 dark:border-gray-600 rounded-md overflow-hidden">
            <div
                class="flex items-center justify-between bg-gray-50 dark:bg-gray-700 border-b border-gray-200 dark:border-gray-600 px-2 py-1">
                <div class="flex gap-1">
                    ...
                    <button type="button" @click="insertPrefix('- ')" title="List"
                        class="px-2 py-0.5 text-xs text-gray-600 dark:text-gray-300 hover:bg-gray-200 dark:hover:bg-gray-600 rounded">•
                        List</button>
            ...
            @else
                <textarea x-ref="textarea" wire:model="body" rows="12" placeholder="What's on your mind? Markdown supported."
        ...
        <input type="text" wire:model="tags" list="tag-hints-compose"
